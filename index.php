  ...
  <body style="background-color: #fff;">
    ...
    <p style="text-align: center; color:#fff; margin-top:5% ;font-size:20px">Giấy chứng nhận ĐKDN: số 0123456789 cấp bởi Phòng ĐKKD Phú Yên ngày 01/01/2023 </p> 
    <p style="text-align: center; color:#fff ;font-size:20px">© Bản quyền thuộc về công ty change THREET</p> 
